...
// @version      4.0.4-ALPHAZERO-BLUNDER-PROOF
// @match         *://lichess.org/*
...
/**
 * ═══════════════════════════════════════════════════════════════════════════
 * PURE ALPHAZERO BOT v4.0.4 - BLUNDER-PROOF (CRITICAL FIX)
 * ═══════════════════════════════════════════════════════════════════════════
 * 
 ...
 * 4. Stuck Detection: Re-calculates if no move in 15 seconds
 * 
...
console.log(`
═══════════════════════════════════════════════════════════════
🛡️ PURE ALPHAZERO v4.0.4 - BLUNDER-PROOF! 🛡️
